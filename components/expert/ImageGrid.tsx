  ...
  function renderCard(img: ImageItem) {
    ...
    return (
      ...
      >
        ...
        <BoundingBoxThumbnail imageUrl={img.imageUrl} bbox={img.bbox} alt="Saved subject" aspectRatio={16 / 9} className="relative mb-4 flex aspect-video items-center justify-center overflow-hidden rounded-lg border border-zinc-800/50 bg-zinc-900" boxClassName="absolute border-2 border-emerald-500 bg-emerald-500/20" />
