    ...
    <nav className={cn(
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between">
        <Link href="/" className="group flex items-center gap-2 transition">
          ...
          <span className="font-bold tracking-tight text-zinc-100 transition-colors group-hover:text-emerald-300">NSTRU<span className="text-zinc-500 font-normal">Vision</span></span>
        </Link>
